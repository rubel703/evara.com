            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-header mb-3">
                        <h3 class="text-center fw-bold mb-3">Total Brand Module: {{ $brand->count() }}</h3>
                    </div>
                            ...
                            <tbody>
                                @foreach ($brand as $brand)
                                    <tr>
                                        ...
                                        <td align="center">
                                            <a href="{{ route('editBrand', $brand->id) }}" class="btn btn-primary">
                                                <i class="fa fa-edit  "></i>
                                            </a>
                                            <a href="{{ route('destroyBrand', $brand->id) }}" class="btn btn-danger">

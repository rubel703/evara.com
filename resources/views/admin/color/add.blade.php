...
@section('body')
    ...
    <div class="container px-4 ">
        <h3 class="text-center fw-bold text-dark" style="margin-top: 3%;margin-bottom:2%;">Add Color</h3>
        ...
        <div class="col-8 offset-2 ">
            ...
            <form method="POST" action="{{ route("color.store") }}" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="color" class="form-control" name="code" id="title" aria-describedby=""/>
                    @error('details')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>

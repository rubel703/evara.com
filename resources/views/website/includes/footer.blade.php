                ...
                <div class="col-lg-4 col-md-6">
                    <div class="widget-about font-md mb-md-5 mb-lg-0">
                        ...
                        <p class="wow fadeIn animated">
                            <strong>Address: </strong>2/kh/Banani,Dhaka,Bangladesh
                        </p>
                        <p class="wow fadeIn animated">
                            <strong>Phone: </strong>+01 2222 365 /(+880) 18240987
                        </p>
                        <p class="wow fadeIn animated">
                            <strong>Hours: </strong>10:00 - 18:00, Sun - Thu
                        </p>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <p class="float-md-left font-sm text-muted mb-0">&copy; 2023, <strong
                        class="text-brand">Evara</strong> - e-commerce </p>
            </div>
            <div class="col-lg-6">
                <p class="text-lg-end text-start font-sm text-muted mb-0">
                    Designed by <a href="http://alithemes.com/" target="_blank">dev.rubel</a>. All rights
                    reserved
                </p>
            </div>
        </div>

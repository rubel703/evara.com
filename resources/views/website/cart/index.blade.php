                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table shopping-summery text-center clean">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="image product-thumbnail"><img src="{{asset($product->options->image)}}"
                                                alt="#"></td>
                                        <td class="product-des product-name">
                                            <h5 class="product-name"><a href="{{route('product-details',['id'=>$product->id])}}" target="_blank">{{$product->name}}</a></h5>
                                            <p class="font-xs">
                                        ...
                                        <td class="action" data-title="Remove">
                                            <a href="{{route('cart.delete',['rowId'=>$product->rowId])}}"
                                                ...
                                                class="btn border-0 bt-danger"> Delete </a>
                                        </td>
                                    </tr>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="cart_total_amount"><span
                                                            class="font-lg fw-900 text-brand">TK.{{$sum}}</span></td>
                                                </tr>
                                                <tr>
                                                    <td class="cart_total_label">Tax Amount(15%)</td>
                                                    <td class="cart_total_amount"><span
                                                            class="font-lg fw-900 text-brand">TK.{{$tax = round($sum*0.15)}}</span></td>
                                                </tr>
                                                <tr>

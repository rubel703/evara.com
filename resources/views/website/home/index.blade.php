                ...
                <div class="row align-items-center slider-animated-1">
                    <div class="col-lg-5 col-md-6">
                        <div class="hero-slider-content-2">
                            <h4 class="animated">{{$offerProduct->title_one}}</h4>
                            <h2 class="animated fw-900">{{$offerProduct->title_two}}</h2>
                            <h1 class="animated fw-900 text-brand">{{$offerProduct->title_three}}</h1>
                            <p class="animated">{{$offerProduct->description}}</p>
                    ...
                    <div class="col-lg-7 col-md-6">
                        <div class="single-slider-img single-slider-img-1">
                            <img class="animated slider-1-1"
                                src="{{ asset($offerProduct->image) }}" alt=""/>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row product-grid-4">
                        @foreach ($products as $product)
                            <div class="col-lg-3 col-md-4 col-12 col-sm-6 mb-4">
                                <div class="product-cart-wrap h-100 mb-30">
                                    ...
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img"
                                                src="{{ asset('/') }}/website/assets/imgs/shop/product-9-1.jpg"
                                                alt="">
                                            <img class="hover-img"
                                                src="{{ asset('/') }}/website/assets/imgs/shop/product-9-2.jpg"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                    ...
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="hover-img"
                                                ...
                                                alt="">
                                            <img class="default-img"
                                                src="{{ asset('/') }}/website/assets/imgs/shop/product-5-2.jpg"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
            ...
            <div class="carausel-6-columns-cover position-relative">
                ...
                <div class="carausel-6-columns" id="carausel-6-columns">
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img
                                    src="{{ asset('/') }}/website/assets/imgs/shop/category-thumb-1.jpg"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"> <img
                                    src="{{ asset('/') }}/website/assets/imgs/shop/category-thumb-2.jpg"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img
                                    src="{{ asset('/') }}/website/assets/imgs/shop/category-thumb-3.jpg"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img
                                    src="{{ asset('/') }}/website/assets/imgs/shop/category-thumb-4.jpg"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img
                                    src="{{ asset('/') }}/website/assets/imgs/shop/category-thumb-5.jpg"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img
                                    src="{{ asset('/') }}/website/assets/imgs/shop/category-thumb-6.jpg"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img
                                    src="{{ asset('/') }}/website/assets/imgs/shop/category-thumb-7.jpg"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img
                                    src="{{ asset('/') }}/website/assets/imgs/shop/category-thumb-8.jpg"
                                    alt=""></a>
                        </figure>
            ...
            <div class="carausel-6-columns-cover position-relative wow fadeIn animated">
                ...
                <div class="carausel-6-columns text-center" id="carausel-6-columns-3">
                    <div class="brand-logo">
                        <img class="img-grey-hover" src="{{ asset('/') }}/website/assets/imgs/banner/brand-1.png"
                            alt="">
                    </div>
                    <div class="brand-logo">
                        <img class="img-grey-hover" src="{{ asset('/') }}/website/assets/imgs/banner/brand-2.png"
                            alt="">
                    </div>
                    <div class="brand-logo">
                        <img class="img-grey-hover" src="{{ asset('/') }}/website/assets/imgs/banner/brand-3.png"
                            alt="">
                    </div>
                    <div class="brand-logo">
                        <img class="img-grey-hover" src="{{ asset('/') }}/website/assets/imgs/banner/brand-4.png"
                            alt="">
                    </div>
                    <div class="brand-logo">
                        <img class="img-grey-hover" src="{{ asset('/') }}/website/assets/imgs/banner/brand-5.png"
                            alt="">
                    </div>
                    <div class="brand-logo">
                        <img class="img-grey-hover" src="{{ asset('/') }}/website/assets/imgs/banner/brand-6.png"
                            alt="">
                    </div>
                    <div class="brand-logo">
                        <img class="img-grey-hover" src="{{ asset('/') }}/website/assets/imgs/banner/brand-3.png"
                    ...
                    <div class="post-list mb-4 mb-lg-0">
                            ...
                            <div class="d-md-flex d-block">
                                <div class="post-thumb d-flex mr-15">
                                    <a class="color-white" href="blog-post-fullwidth.html">
                                        <img src="{{ asset('/') }}/website/assets/imgs/blog/blog-2.jpg"
                                            alt="">
                                    </a>
                                </div>
                        ...
                        <article class="wow fadeIn animated">
                            <div class="d-md-flex d-block">
                                <div class="post-thumb d-flex mr-15">
                                    <a class="color-white" href="blog-post-fullwidth.html">
                                        <img src="{{ asset('/') }}/website/assets/imgs/blog/blog-1.jpg"
                                            alt="">
                                    </a>
                                </div>
                                <div class="post-content">
                ...
                <div class="col-lg-3 col-md-6 mb-sm-5 mb-md-0">
                    ...
                    <div class="product-list-small wow fadeIn animated">
                        <article class="row align-items-center">
                            <figure class="col-md-4 mb-0">
                                <a href="shop-product-right.html"><img
                                        src="{{ asset('/') }}/website/assets/imgs/shop/thumbnail-3.jpg"
                                        alt=""></a>
                            </figure>
                        ...
                        <article class="row align-items-center">
                            <figure class="col-md-4 mb-0">
                                <a href="shop-product-right.html"><img
                                        src="{{ asset('/') }}/website/assets/imgs/shop/thumbnail-4.jpg"
                                        alt=""></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h4 class="title-small">
                        ...
                        <article class="row align-items-center">
                            <figure class="col-md-4 mb-0">
                                <a href="shop-product-right.html"><img
                                        src="{{ asset('/') }}/website/assets/imgs/shop/thumbnail-5.jpg"
                                        alt=""></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h4 class="title-small">
                ...
                <div class="col-lg-3 col-md-6 mb-sm-5 mb-md-0">
                    ...
                    <div class="product-list-small wow fadeIn animated">
                        <article class="row align-items-center">
                            <figure class="col-md-4 mb-0">
                                <a href="shop-product-right.html"><img
                                        src="{{ asset('/') }}/website/assets/imgs/shop/thumbnail-6.jpg"
                                        alt=""></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h4 class="title-small">
                        ...
                        <article class="row align-items-center">
                            <figure class="col-md-4 mb-0">
                                <a href="shop-product-right.html"><img
                                        src="{{ asset('/') }}/website/assets/imgs/shop/thumbnail-7.jpg"
                                        alt=""></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h4 class="title-small">
                        ...
                        <article class="row align-items-center">
                            <figure class="col-md-4 mb-0">
                                <a href="shop-product-right.html"><img
                                        src="{{ asset('/') }}/website/assets/imgs/shop/thumbnail-8.jpg"
                                        alt=""></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h4 class="title-small">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="product-list-small wow fadeIn animated">
                        <article class="row align-items-center">
                            <figure class="col-md-4 mb-0">
                                <a href="shop-product-right.html"><img
                                        src="{{ asset('/') }}/website/assets/imgs/shop/thumbnail-9.jpg"
                                        alt=""></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h4 class="title-small">
                        ...
                        <article class="row align-items-center">
                            <figure class="col-md-4 mb-0">
                                <a href="shop-product-right.html"><img
                                        src="{{ asset('/') }}/website/assets/imgs/shop/thumbnail-1.jpg"
                                        alt=""></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h4 class="title-small">
                        ...
                        <article class="row align-items-center">
                            <figure class="col-md-4 mb-0">
                                <a href="shop-product-right.html"><img
                                        src="{{ asset('/') }}/website/assets/imgs/shop/thumbnail-2.jpg"
                                        alt=""></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h4 class="title-small">
